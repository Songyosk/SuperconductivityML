...
class engineering():
    ...
    def save(self, test_size=0.2, random_state=42, *args, **kwargs):
        """
        ...
        # Split dataset
        if stratify != None:
            df_train, df_test = train_test_split(self.sample_train, test_size=test_size, random_state=random_state, stratify=stratify) 
        else:
